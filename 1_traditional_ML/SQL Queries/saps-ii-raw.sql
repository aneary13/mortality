...
DROP MATERIALIZED VIEW IF EXISTS sapsii_raw CASCADE;
CREATE MATERIALIZED VIEW sapsii_raw as
  ...
  , case
   ...
   , case
	...
	, case
        ...
        when HEM  = 1 then 'Haematologic Malignancy'
        when METS = 1 then 'Metastatic Cancer'
        else Null
      end as comorbidity
